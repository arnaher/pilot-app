...
const App = () => {
  ...
  // États sans localStorage (fonctionnera en production avec localStorage)
  ...
  const [plusOneLogs, setPlusOneLogs] = useState<LogEntry[]>([]);

  const [crisisData, setCrisisData] = useState<CrisisState>({
    supportPerson: "",
    booster: ""
  });
